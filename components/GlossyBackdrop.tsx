...
export function GlossyBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <div
        className="absolute -top-40 right-[-12%] h-[560px] w-[560px] rounded-full blur-[120px] animate-drift-a"
        style={{ background: "radial-gradient(circle, rgba(212,175,55,0.32), transparent 70%)" }}
      />
      <div
        className="absolute bottom-[-25%] left-[-12%] h-[520px] w-[520px] rounded-full blur-[120px] animate-drift-b"
